...
<script type="text/babel">
  ...
  import scrollIntoView from 'jintu-ui/src/utils/scroll-into-view';
  import { getValueByPath, valueEquals, isIE, isEdge } from 'jintu-ui/src/utils/util';
  import NavigationMixin from './navigation-mixin';
  import { isKorean } from 'jintu-ui/src/utils/shared';
